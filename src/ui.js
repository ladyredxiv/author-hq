  ...
  <head>
    ...
    <style>
      ...
      *{box-sizing:border-box}
      ...
      .book-add-panel{margin-bottom:18px;padding:0}.book-add-panel>summary{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:15px 18px;cursor:pointer;font-weight:800;list-style:none}.book-add-panel>summary::-webkit-details-marker{display:none}.book-add-panel>summary::before{content:'+';display:inline-grid;place-items:center;width:24px;height:24px;border:1px solid var(--line);border-radius:6px;color:var(--accent2);margin-right:9px}.book-add-panel[open]>summary::before{content:'-'} .book-add-panel>summary .tiny{margin-left:auto;font-weight:500}.book-add-body{border-top:1px solid var(--line);padding:18px}.book-catalog{display:grid;gap:12px}.book-catalog>.section-title-row{margin:0}.book-catalog>.section-title-row p{margin:4px 0 0;font-size:12px}.catalog-toolbar{display:grid;gap:12px}.catalog-tabs{display:flex;gap:7px;flex-wrap:wrap}.catalog-tab{display:flex;align-items:center;gap:9px;padding:8px 11px;border:1px solid var(--line);border-radius:7px;background:var(--panel2);color:#c8d3e8;text-decoration:none;font-size:12px;font-weight:750}.catalog-tab strong{display:inline-grid;place-items:center;min-width:22px;height:20px;padding:0 6px;border-radius:999px;background:#26314b;color:#dce7ff;font-size:10px}.catalog-tab.active{background:#1b2440;border-color:#476494;color:white;box-shadow:inset 3px 0 0 var(--accent2)}.catalog-filters{display:grid;grid-template-columns:minmax(220px,1.4fr) repeat(4,minmax(140px,1fr)) auto;gap:10px;align-items:end;padding:12px;border:1px solid var(--line);border-radius:8px;background:var(--panel)}.catalog-filters .field{min-width:0}.catalog-filter-actions{display:flex;gap:7px}.catalog-filter-actions button,.catalog-filter-actions .button{padding:10px 11px;font-size:12px;white-space:nowrap}.book-table-wrap{min-width:0;overflow:auto;border:1px solid var(--line);border-radius:8px}.book-catalog-table{min-width:1040px;border:0;border-radius:0}.book-title-cell{min-width:230px}.book-title-cell strong,.book-title-cell span,.book-catalog-table td:nth-child(5) strong,.book-catalog-table td:nth-child(5) span{display:block}.book-title-cell span{margin-top:4px;color:var(--muted);font-size:11px}.book-notes-cell{max-width:260px;color:var(--muted);line-height:1.4}.book-actions-cell{width:245px}.book-actions-cell .action-row{flex-wrap:nowrap}.catalog-empty{display:grid;gap:5px;place-items:center;padding:44px 20px;border:1px dashed var(--line);border-radius:8px;background:var(--panel2);text-align:center}.catalog-empty span{color:var(--muted);font-size:12px}
      ...
      .reconciliation-table td{vertical-align:middle}.reconcile-status{display:inline-flex;align-items:center;border:1px solid var(--line);border-radius:999px;padding:3px 8px;font-size:11px;font-weight:800}.status-matched{border-color:#24583f;background:#10291f;color:#94e0ba}.status-suggested{border-color:#34557d;background:#111d31;color:#a9ccff}.status-missing,.status-overdue,.status-amount-changed{border-color:#7b3338;background:#331d20;color:#ffb0b3}.status-paused{color:var(--muted)}
